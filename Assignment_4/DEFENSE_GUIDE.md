...
**🇷🇺 Русский:**  
Это задание фокусируется на **Разведочном анализе данных (EDA)** — понимании данных **before** построения моделей. Вы будете анализировать датасет Ames Housing, чтобы определить, какие признаки (качество, размер, расположение) наиболее сильно предсказывают цены домов.
